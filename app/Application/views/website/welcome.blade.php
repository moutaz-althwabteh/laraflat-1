            ...
            @if (Route::has('login'))
                <ul class="top-right links">
                    ...
                    @else
                        ...
                        <li><a href="http://localhost:8000/auth/facebook">Facebook</a></li>
                        <li> <a href="http://localhost:8000/auth/twitter">Twitter</a></li>
                        <li><a href="http://localhost:8000/auth/github">GitHub</a></li>
                    @endif
