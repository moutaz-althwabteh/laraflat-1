...
use App\Application\Transformers\AdvertisementTransformers;

class AdvertisementApi extends Controller
{

    protected $request;
    protected $model;

    public function __construct(Advertisement $model , Request $request)
    {
        $this->model = $model;
    ...
    public function index($limit = 10 , $offset = 0 , $lang = "en"){
       ...
       return response(apiReturn(AdvertisementTransformers::transform($data))  , 200 );
    }
