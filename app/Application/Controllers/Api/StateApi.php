...
use App\Application\Transformers\StateTransformers;
...
class StateApi extends Controller
{
    ...
    public function __construct(State $model , Request $request)
    {
        $this->model = $model;
    ...
    public function index($limit = 10 , $offset = 0 , $lang = "en"){
       ...
       return response(apiReturn(StateTransformers::transform($data))  , 200 );
    }
